...
println("="^78);
println("ARROW 6 PROBE — MeTTa-IL -> MORK/PathMap");
println("="^78)
...
ask(
    ...
    () -> begin
        ...
        "trie atoms $n0 -> $n1" *
        (n1 > n0 ? "   THE STORE HALF WORKS" : "   NOTHING LANDED")
    end
)
ask(
    "Q4  RETRIEVAL core_match",
    () -> begin
...
println("\n", "="^78)
println(
    "READ: Q1/Q2 green + Q3/Q4 green + Q5 RAISED  => arrow 6 is a ROUTING gap, not a store gap."
)
println(
    "      Q5 returning [42]                      => arrow 6 is ROUTED (update the ledger)."
)
println("="^78)
