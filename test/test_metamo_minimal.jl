# Runs the CANONICAL test_metamo.jl assertions on the MeTTaCore.Interpreter evaluator instead of the
...
qmm = q                              # Interpreter-backed harness: query -> Julia values (via mval)
